...
module.exports = {
    entry: {
        app: [path.resolve(__dirname, 'react-app/index.js')],
    ...
    plugins: [
        definePlugin, new ExtractTextPlugin("../css/style.css"), new webpack.IgnorePlugin(/^\.\/locale$/, /moment$/),
        new webpack
            .optimize
            .UglifyJsPlugin({
                drop_console: true,
        ...
        new webpack
            .optimize
            .CommonsChunkPlugin('react', 'react.js'),
